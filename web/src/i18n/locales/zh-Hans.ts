const zhHans = {
  ...
  serviceDesk: {
    ...
    workbench: {
      ...
      assistDraftTitle: 'AI 辅助草稿',
      assistDraftHint: '只生成草稿，不会直接发送给客户，仍需人工确认后发送。',
      generateAssistDraft: '生成 AI 草稿',
      assistDraftBadge: 'AI 辅助草稿已填入回复框',
      assistDraftSuccess: 'AI 草稿已生成',
      assistDraftError: '生成 AI 草稿失败',
      sendReply: '发送人工回复',
