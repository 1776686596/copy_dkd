const zhHans = {
  ...
  models: {
    ...
    langbotModelsDescription: '登录后可直接使用的云端模型',
    credits: '积分',
    loginWithSpace: '通过 Space 登录',
  ...
  serviceDesk: {
    title: '客服台',
    description: '处理企微客服、企微私域与飞书私聊的人工接管、规则配置和快捷素材',
    heroTitle: '客服工作台',
    heroDescription:
      '围绕人工接管、规则切换和素材回复组织为单页调度台，支持企微客服、企微私域和飞书私聊接入与坐席值守。',
    wecomOnlyHint:
      '当前展示适配器为 `wecomcs`、`wecomprivate` 或 `lark` 的客服渠道机器人。',
    noBotsTitle: '还没有可用的客服渠道机器人',
    noBotsDescription:
      '请先在机器人页创建并配置 `wecomcs`、`wecomprivate` 或 `lark` 适配器，客服台才会展示会话和规则能力。',
    channels: {
      wecomcs: '企微客服',
      wecomprivate: '企微私域',
      lark: '飞书私聊',
    ...
    workbench: {
      selectBot: '客服号',
      queueFilter: '队列筛选',
      searchPlaceholder: '搜索会话 ID、外部用户或处理人',
      claimedByFilter: '认领筛选',
      claimedByAll: '全部会话',
      claimedByClaimed: '仅看已认领',
      claimedByUnclaimed: '仅看未认领',
      refresh: '刷新',
      autoRefresh: '工作台每 15 秒自动刷新',
      sessionsTitle: '会话队列',
      sessionsDescription:
        '优先处理待人工和人工中的会话，静默与 AI 队列可用于回看。',
      ...
      handoffReason: '转人工原因',
      claimedBy: '当前处理人',
      unresolvedCount: '未解决轮次',
      replyPlaceholder: '输入人工回复内容，发送后会更新会话状态。',
      claimAction: '认领会话',
      claimHint: '未认领前不能发送人工回复。',
      claimSuccess: '会话已认领',
      claimError: '认领会话失败',
      releaseAction: '释放会话',
      releaseSuccess: '会话已释放回待人工队列',
      releaseError: '释放会话失败',
      returnToAiAction: '返回 AI 托管',
      returnToAiSuccess: '会话已返回 AI 托管',
      returnToAiError: '返回 AI 托管失败',
      assistDraftTitle: 'AI 建议',
      assistDraftHint: '基于当前聊天记录实时生成建议，不会自动发送，可按需插入回复框。',
      generateAssistDraft: 'AI 建议',
      assistDraftBadge: 'AI 建议已生成',
      assistDraftSuccess: 'AI 建议已生成',
      assistDraftError: '生成 AI 建议失败',
      insertAssistDraft: '插入回复框',
      sendReply: '发送人工回复',
      ...
      leadTitle: '线索画像',
      leadDescription: '查看私域线索来源、标签和当前画像状态。',
      leadExternalUser: '外部联系人',
      leadFollowUser: '归属成员',
      leadSourceState: '渠道状态',
      leadProfileStatus: '画像状态',
      leadUserLayer: '用户层级',
      leadLayerSource: '分层来源',
      leadProfileSignals: '识别信号',
      leadLayerUpdatedAt: '最近刷新',
      leadTags: '当前标签',
      leadEmpty: '当前会话还没有私域线索信息',
      userLayer: {
        normal: '普通用户',
        new_user: '新用户',
        vip: 'VIP',
      ...
      routingTitle: '分流记录',
      routingDescription: '保留命中规则后的分流决策，便于复盘转人工原因。',
      routingEmpty: '当前会话还没有分流记录',
      bindingTitle: '绑定补录',
      bindingDescription: '人工补录 UID / 区服 / 角色名，作为后续标签和闭环的基础信息。',
      bindingUidLabel: 'UID',
      bindingServerLabel: '区服',
      bindingRoleNameLabel: '角色名',
      bindingUidPlaceholder: '输入 UID',
      bindingServerPlaceholder: '输入区服',
      bindingRoleNamePlaceholder: '输入角色名',
      bindingStatus: '当前绑定状态',
      bindingEmpty: '尚未保存绑定补录',
      bindingSave: '保存绑定',
      bindingSaveSuccess: '绑定补录已保存',
      bindingSaveError: '保存绑定补录失败',
      closureTitle: '会话闭环',
      closureDescription: '在会话结束时回写备注、标签并记录知识反馈。',
      closureTags: '闭环标签',
      closureTagsPlaceholder: '输入要新增的标签，使用逗号或换行分隔',
      closureRemarkPlaceholder: '输入会后备注，例如 UID、区服或处理结论',
      closureFeedback: '知识反馈',
      closureFeedbackPlaceholder: '记录需补充的 FAQ 或知识库反馈',
      closureResolution: '闭环结果',
      closureOperator: '闭环人',
      closureTime: '闭环时间',
      closeAction: '执行闭环',
      closeSuccess: '会话已闭环',
      closeError: '会话闭环失败',
      closedHint: '该会话已闭环，不能再继续发送人工回复。',
    },
    config: {
      title: '客服号规则',
      ...
      fallbackUnresolvedCount: '连续未解决次数',
      manualTimeoutSeconds: '人工超时秒数',
      enabled: '启用客服台规则',
      enabledHint: '关闭后该客服号继续走默认 AI 流程，不触发人工接管逻辑。',
      saveSuccess: '客服号规则已保存',
      saveError: '保存客服号规则失败',
      pipelineBinding: '绑定流水线',
      adapterType: '适配器',
      wecomPrivate: {
        title: '固定二维码',
        description: '同步企微私域的主二维码配置，用于导流和客服会话建档。',
        receptionTitle: 'AI 自动接待',
        receptionDescription: '配置私域入口的自动接待、补录字段和人工转接规则。',
        receptionEnabled: '启用自动接待',
        receptionEnabledHint: '关闭后私域入口不走自动接待闭环，回到默认流程处理。',
        welcomeEnabled: '发送欢迎消息',
        welcomeEnabledHint: '新线索进入时继续发送欢迎消息。',
        humanHandoffDirectEnabled: '明确诉求直接转人工',
        humanHandoffDirectEnabledHint: '命中明确人工诉求时，直接进入待人工接管状态。',
        bindingRequiredFields: '必填绑定字段',
        bindingRequiredFieldsHint:
          '用逗号或换行分隔，可选 uid、server、role_name。留空时默认 uid、server。',
        bindingRequiredFieldsPlaceholder: 'uid\nserver',
        bindingTriggerKeywords: '触发补录关键词',
        bindingTriggerKeywordsHint: '用逗号或换行分隔，留空表示仅按流程触发。',
        bindingTriggerKeywordsPlaceholder: '绑定\n角色名',
        bindingPromptText: '补录提示文案',
        bindingPromptTextHint: '触发补录后发给用户的提示话术，可留空。',
        bindingPromptTextPlaceholder: '请提供 UID、区服和角色名，方便继续处理。',
        fallbackReplyText: '兜底回复文案',
        fallbackReplyTextHint: '无法继续追问时发送的兜底话术，可留空。',
        fallbackReplyTextPlaceholder: '如需人工处理，请直接回复人工。',
        receptionLoadError: '加载自动接待配置失败',
        followUserId: '成员 ID',
        contactState: '渠道状态',
        contactRemark: '二维码备注',
        followUserRequired: '请先填写成员 ID',
        syncAction: '同步二维码',
        syncingAction: '同步中...',
        syncSuccess: '固定二维码已同步',
        syncError: '固定二维码同步失败',
        loadError: '加载固定二维码失败',
        qrPreview: '二维码预览',
        emptyQr: '当前还没有已同步的固定二维码',
        primaryState: '当前 state',
        lastSynced: '最近同步时间',
      },
    },
    materials: {
      title: '快捷素材库',
      description: '维护命中关键词后的快捷回复素材，优先级越小越先匹配。',
      existingTitle: '已生效素材',
      empty: '当前客服号还没有素材',
      formTitle: '新增素材',
      materialType: '素材类型',
      materialTypeHint: '当前后端仅做存储，可用作分类标签。',
      materialTitle: '素材标题',
      triggerKeywords: '触发关键词',
      triggerKeywordsHint: '用逗号或换行分隔，客户消息命中任一关键词即触发。',
      replyText: '回复内容',
      priority: '优先级',
      enabled: '启用素材',
      createAction: '新增素材',
  ...
  knowledge: {
    ...
    documentsTab: {
      ...
      supportedFormatsLocalFaq:
        '支持 XLSX、CSV、JSON 问答文件，上传后会自动解析为问答条目',
    ...
    entries: {
      tab: '条目',
      title: '问答条目',
      description: '在页面内查看、添加和修改本地问答库条目。',
      addAction: '添加条目',
      addTitle: '添加问答条目',
      editTitle: '编辑问答条目',
      dialogDescription: '问题支持按换行、分号拆分为多个触发问法。',
      empty: '暂无问答条目',
      loadError: '加载条目失败：',
      saveError: '保存条目失败：',
      createSuccess: '条目创建成功',
      updateSuccess: '条目更新成功',
      deleteSuccess: '条目删除成功',
      deleteError: '删除条目失败：',
      deleteConfirm: '确认删除这条问答条目吗？',
      questions: '问题',
      questionsPlaceholder: '每行一个问题，或用分号分隔多个问法',
      questionsHint: '例如：哪个职业好玩？\\n职业推荐',
      answer: '回答',
      answerPlaceholder: '输入标准答案',
      enabled: '启用',
      disabled: '停用',
      enabledHint: '关闭后，该条目不会参与命中。',
      status: '状态',
      sourceFile: '来源文件',
