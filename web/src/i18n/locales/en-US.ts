const enUS = {
  ...
  serviceDesk: {
    ...
    workbench: {
      ...
      assistDraftTitle: 'AI Assist Draft',
      assistDraftHint:
        'Generate a draft only. Nothing is sent to the customer until an operator reviews and sends it.',
      generateAssistDraft: 'Generate AI Draft',
      assistDraftBadge: 'AI assist draft inserted into reply box',
      assistDraftSuccess: 'AI draft generated',
      assistDraftError: 'Failed to generate AI draft',
