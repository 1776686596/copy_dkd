const enUS = {
  ...
  common: {
    ...
    loginKeyFailed: 'Login failed, please check your login key',
    ...
    enterLoginKey: 'Enter demo login key',
    invalidEmail: 'Please enter a valid email address',
    emptyPassword: 'Please enter your password',
    emptyLoginKey: 'Please enter your login key',
    language: 'Language',
    helpDocs: 'Get Help',
  ...
  serviceDesk: {
    ...
    workbench: {
      ...
      searchPlaceholder: 'Search session ID, external user, or operator',
      claimedByFilter: 'Claim Filter',
      claimedByAll: 'All Sessions',
      claimedByClaimed: 'Claimed Only',
      claimedByUnclaimed: 'Unclaimed Only',
      refresh: 'Refresh',
      autoRefresh: 'Workbench refreshes every 15 seconds',
      sessionsTitle: 'Session Queue',
      sessionsDescription:
        'Prioritize pending and manual sessions. Silent and AI queues remain available for review.',
      ...
      replyPlaceholder:
        'Type a manual reply here. Sending it will update the session state.',
      claimAction: 'Claim Session',
      claimHint: 'Manual reply is disabled until the session is claimed.',
      claimSuccess: 'Session claimed',
      claimError: 'Failed to claim session',
      releaseAction: 'Release Session',
      releaseSuccess: 'Session returned to pending manual queue',
      releaseError: 'Failed to release session',
      returnToAiAction: 'Return To AI',
      returnToAiSuccess: 'Session returned to AI hosted state',
      returnToAiError: 'Failed to return session to AI',
      assistDraftTitle: 'AI Suggestions',
      assistDraftHint:
        'Generate suggestions from the current conversation. Nothing is sent automatically, and operators can insert them into the reply box when needed.',
      generateAssistDraft: 'AI Suggestions',
      assistDraftBadge: 'Suggestions ready',
      assistDraftSuccess: 'AI suggestions generated',
      assistDraftError: 'Failed to generate AI suggestions',
      insertAssistDraft: 'Insert into reply box',
    ...
    config: {
      ...
      handoffKeywordsHint:
        'Separate keywords with commas or new lines, for example: human, complaint, refund',
      fallbackUnresolvedCount: 'Fallback Unresolved Count',
      manualTimeoutSeconds: 'Manual Timeout (seconds)',
      enabled: 'Enable Service Desk Rules',
      enabledHint:
        'When disabled, this bot keeps using the default AI flow without manual handoff logic.',
      saveSuccess: 'Bot rules saved',
    ...
    materials: {
      ...
      description:
        'Maintain keyword-triggered quick replies. Lower priority values match first.',
      existingTitle: 'Active Materials',
      empty: 'No material is configured for this bot yet',
      formTitle: 'Create Material',
      materialType: 'Material Type',
      materialTypeHint:
        'The backend currently stores this as a classification label only.',
      materialTitle: 'Material Title',
      triggerKeywords: 'Trigger Keywords',
      triggerKeywordsHint:
        'Separate with commas or new lines. Any matched keyword will trigger the reply.',
      replyText: 'Reply Text',
      priority: 'Priority',
      enabled: 'Enable Material',
      createAction: 'Create Material',
      createSuccess: 'Material created',
      createError: 'Failed to create material',
      noBotHint: 'Select a bot before managing materials.',
    },
  },
  bots: {
    title: 'Bots',
  ...
  knowledge: {
    ...
    documentsTab: {
      ...
      supportedFormatsLocalFaq:
        'Supports XLSX, CSV and JSON FAQ files. Uploaded files will be parsed into FAQ entries automatically',
    ...
    entries: {
      ...
      dialogDescription:
        'Questions can be split into multiple triggers by line breaks or semicolons.',
      ...
      questions: 'Questions',
      questionsPlaceholder: 'One question per line, or separate by semicolons',
      questionsHint: 'Example: Which class is fun?\\nClass recommendation',
      answer: 'Answer',
      answerPlaceholder: 'Enter the standard answer',
      enabled: 'Enabled',
      disabled: 'Disabled',
      enabledHint: 'Disabled entries will not participate in matching.',
      status: 'Status',
      sourceFile: 'Source File',
      matchedQuestion: 'Matched Question',
      standardAnswer: 'Standard Answer',
      finalAnswer: 'Final Reply',
    },
