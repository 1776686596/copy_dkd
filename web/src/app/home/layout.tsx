...
import { PluginInstallTaskProvider } from '@/app/home/plugins/components/plugin-install-task';

const HomeSidebar = lazy(
  () => import('@/app/home/components/home-sidebar/HomeSidebar'),
);
const SurveyWidget = lazy(
  () => import('@/app/home/components/survey/SurveyWidget'),
);
const PluginInstallProgressDialog = lazy(
  () =>
    import('@/app/home/plugins/components/plugin-install-task/PluginInstallProgressDialog'),
);
