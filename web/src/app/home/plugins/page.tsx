...
function PluginListView() {
  ...
  const checkExtensionsLimit = useCallback(async (): Promise<boolean> => {
  ...
  const installPlugin = useCallback(
    (installSource: string, installInfo: Record<string, any>) => {
    ...
    [addTask, resetGithubState, selectedAsset?.size, setSelectedTaskId],
  );
  ...
  const uploadPluginFile = useCallback(
    ...
    [checkExtensionsLimit, installPlugin, pluginSystemStatus, t],
  );
