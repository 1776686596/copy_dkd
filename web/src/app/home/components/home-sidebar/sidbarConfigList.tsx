  ...
  new SidebarChildVO({
    ...
    icon: (
      <svg
        ...
        className="text-blue-500"
      >
        <path d="M12 2C7.02944 2 3 5.80558 3 10.5C3 12.5896 3.79873 14.503 5.12479 15.9791C4.66204 17.2411 3.92949 18.4042 2.96845 19.3777C2.68141 19.6685 2.59503 20.1057 2.74983 20.4855C2.90464 20.8654 3.26877 21.113 3.67764 21.113C5.84279 21.113 7.74444 20.4007 9.24963 19.2528C10.1323 19.5834 11.0917 19.7778 12 19.7778C16.9706 19.7778 21 15.9722 21 11.2778C21 6.58336 16.9706 2.77778 12 2.77778V2ZM8.5 9.5C9.32843 9.5 10 10.1716 10 11C10 11.8284 9.32843 12.5 8.5 12.5C7.67157 12.5 7 11.8284 7 11C7 10.1716 7.67157 9.5 8.5 9.5ZM12 9.5C12.8284 9.5 13.5 10.1716 13.5 11C13.5 11.8284 12.8284 12.5 12 12.5C11.1716 12.5 10.5 11.8284 10.5 11C10.5 10.1716 11.1716 9.5 12 9.5ZM15.5 9.5C16.3284 9.5 17 10.1716 17 11C17 11.8284 16.3284 12.5 15.5 12.5C14.6716 12.5 14 11.8284 14 11C14 10.1716 14.6716 9.5 15.5 9.5Z"></path>
      </svg>
    ),
