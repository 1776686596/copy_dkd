...
export default function HomeSidebar({
  ...
  const initSelectRef = useRef(initSelect);
  const handleRouteChangeRef = useRef(handleRouteChange);
  initSelectRef.current = initSelect;
  handleRouteChangeRef.current = handleRouteChange;

  useEffect(() => {
    handleRouteChangeRef.current(pathname);
  }, [pathname]);
                ...
                >
                  ...
                  <DropdownMenuGroup>
                    ...
                    <DropdownMenuItem
                      onClick={() => {
                        window.open(
                          'https://github.com/1776686596/copy_dkd/issues',
                          '_blank',
                        );
                      }}
                    >
                    ...
                    <DropdownMenuItem
                      onClick={() => {
                        window.open(
                          'https://github.com/1776686596/copy_dkd',
                          '_blank',
                        );
                      }}
                    >
